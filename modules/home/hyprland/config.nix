  ...
  wayland.windowManager.hyprland = {
    settings = {
      ...
      exec-once = [
        ...
        "[workspace 2 silent] gnome-clock"
      ];
      ...
      bind = [
        ...
        #scratch
        "$mainMod, Tab, exec, wezterm start --class scratchterm --always-new-process"
      ...
      #   "$mainMod, XF86MonBrightnessDowne, exec, brightnessctl set 100%-"
      # ];
